# Generated by Django 4.2 on 2024-08-27 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='news.field')),
            ],
            options={
                'verbose_name': 'field Translation',
                'db_table': 'news_field_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
